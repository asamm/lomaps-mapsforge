...
class TemplateVariables(Template):
    ...
    ################################################################
    ## COLORS EXTRACTED FROM theme_template.xml (was hardcoded literals)
    ## Step 1: 1 variable per unique color value. Consolidation is a later step.
    ################################################################
    ...
    color_glacier                    = '#50d3e9ff'  # natural=glacier fill
    color_marina_case_outer          = '#604f9cbf'  # marina stroke (outer)
    color_marina_case_inner          = '#404f9cbf'  # marina stroke (inner)
    ...
    color_landuse_residential_car    = '#dcdcdc'  # CAR residential industrial
    color_landuse_residential_sum    = '#e0d4b3'  # SUMMER residential (via $darken) + leisure stadium/sports_centre/water_park case
    color_landuse_residential_sum_t  = '#90e0d4b3'  # SUMMER residential translucent
    color_landuse_residential_city_t = '#80dcdcdc'  # residential_city translucent
    color_landuse_residential_win    = '#e2e2e2'  # WINTER residential
    color_landuse_industrial_sum     = '#90bfbfcf'  # SUMMER industrial/brownfield/railway
    color_landuse_quarry             = '#d6d6e1'  # quarry + power areal

    ### natural / landcover ###
    color_forest_summer_scrub        = '#30a0ca6c'  # scrub/fell SUMMER
    ...
    color_scree_shingle              = '#80dddfe5'  # natural=scree/shingle
    color_wetland_tidalflat          = '#108f5011'  # wetland=tidalflat
    ...
    color_national_park_border       = '#9040be39'  # national_park stroke
    color_national_park_border2      = '#cc40be39'  # national_park stroke
    ...
    color_cemetery_fill              = '#80bdd16c'  # cemetery/grave_yard/vineyard/orchard fill
    color_cemetery_case              = '#e4e4e4'  # cemetery/grave_yard stroke
    color_grave_yard_fill            = '#8096bfbe'  # amenity=grave_yard fill
    ...
    ### aeroway ###
    color_aerodrome_area             = '#20cdeca7'  # aeroway=aerodrome translucent

    ### military ###
    color_military_fill              = '#25e57a7a'  # landuse/military airfield fill
    color_military_case              = '#70e57a7a'  # military stroke
    color_military_case2             = '#90e57a7a'  # military stroke
    ...
    ### highways - shields / link captions ###
    ...
    ### highways - motorway junction ###
    color_motorway_junction_fill     = '#d97f05'  # motorway_junction fill
    color_motorway_junction_case     = '#ff5b58'  # motorway_junction stroke

    ### path halos ###
    color_path_halo_translucent      = '#aaffffff'  # path standard/winter halo
    color_footway_halo_winter        = '#40ffffff'  # footway/corridor winter (no white halo)
    ...
    color_railway_tunnel_subway      = '#408c0000'  # subway tunnel
    color_railway_tunnel_tram        = '#cf2b2e'  # tram tunnel
    color_railway_tunnel_tram_topo   = '#880f0f4c'  # tram/miniature tunnel topo
    color_railway_tunnel_rail        = '#904d4d4d'  # rail/light_rail/etc tunnel
    color_power_tower_label          = '#90707070'  # power=tower label
    ...
    ### snowmobile / ski ###
    color_snowmobile                 = '#90ee7e00'  # snowmobile designated
    ...
    color_ski_nordic_halo            = '#90ffffff'  # nordic/backcountry/hike halo
    color_ski_tour_halo              = '#ccffffff'  # skitour/sled halo
